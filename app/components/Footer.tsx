...
const columns = [
  ...
  { title: 'Company', links: [['Readiness Assessment', '/ai-agent-readiness-assessment'], ['Results', '/results'], ['Insights', '/insights'], ['Editorial Standards', '/about/editorial-standards'], ['Book an Audit', '/book']] },
];
