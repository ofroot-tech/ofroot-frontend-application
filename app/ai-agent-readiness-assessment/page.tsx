...
export default function AiAgentReadinessAssessmentPage() {
  ...
  return <main id="main-content" className="bg-[#f7f6f2] px-6 py-12 text-slate-950 sm:px-8 sm:py-16"><JsonLd data={[webApplication, breadcrumb]} /><div className="mx-auto max-w-5xl"><nav aria-label="Breadcrumb" className="mb-7 text-sm text-slate-500"><Link href="/">Home</Link> / <span className="text-slate-800">AI Agent Readiness Assessment</span></nav><div className="mb-8 max-w-3xl"><p className="text-sm font-bold uppercase tracking-[.16em] text-[#9A4A00]">Free decision-support tool · about 4 minutes</p><h1 className="mt-3 text-balance text-4xl font-black sm:text-6xl">Is your business ready for an AI agent?</h1><p className="mt-5 text-lg leading-8 text-slate-600">Answer 12 practical questions. You will receive a readiness score, a six-part breakdown, and the three operating gaps to address first.</p></div><ReadinessAssessment /><div className="mt-10 grid gap-5 border-t border-slate-200 pt-10 sm:grid-cols-3"><div><h2 className="text-lg font-black">What it measures</h2><p className="mt-2 text-sm leading-6 text-slate-600">Workflow, value, data, permissions, controls, and operations—not model enthusiasm.</p></div><div><h2 className="text-lg font-black">What it does not do</h2><p className="mt-2 text-sm leading-6 text-slate-600">It is not a certification, compliance review, or guarantee that an implementation will succeed.</p></div><div><h2 className="text-lg font-black">How it is scored</h2><p className="mt-2 text-sm leading-6 text-slate-600">Every dimension is weighted equally in version 1.0. <Link href="/research/ai-agent-readiness-methodology" className="font-bold text-[#8F4700] underline">See the full methodology.</Link></p></div></div></div></main>;
}
