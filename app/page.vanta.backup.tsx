          ...
          <div style={{ position: "relative", zIndex: 1, height: "100%" }} className="hero-wrapper flex items-center justify-center p-8 sm:p-20">
            <main className="flex flex-col gap-[48px] items-center sm:items-start max-w-5xl">
              ...
              <div className="flex items-center flex-col sm:flex-row gap-3 sm:gap-4">
                <a className="loading-on-click inline-flex items-center justify-center text-center bg-white text-[#FF9312] hover:bg-gray-100 font-semibold py-3 px-6 rounded-full transition-all duration-300 shadow-lg text-base fade-up delayed" href="#services" aria-label="Explore OfRoot services">Explore Services</a>
                <a className="loading-on-click inline-flex items-center justify-center text-center bg-[#FF9312] text-white hover:bg-[#E07F00] font-semibold py-3 px-6 rounded-full transition-all duration-300 shadow-lg text-base fade-up delayed" href="https://form.jotform.com/252643426225151" target="_blank" rel="noopener noreferrer" aria-label="Book a 20 minute scoping call" style={{ boxShadow: '0 6px 18px rgba(255,255,255,0.6), 0 4px 12px rgba(255,147,18,0.16)' }}>Book a 20-min scoping call</a>
